                  ...
                  <table class="items-center w-full mb-0 align-top border-collapse dark:border-white/40 text-slate-500">
                    ...
                    <?php foreach ($products as $product): ?>
                      <tr>
                        ...
                        <td class="p-2 text-sm leading-normal text-center align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent break-all">
                          <span class="bg-gradient-to-tl  px-2.5 text-xs dark:text-white rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline leading-none break-all"><?= $product['description'] ?></span>
                        </td>
